...
## 2. Индивидуальное задание (Вариант 17)
...
│   Команды:                                                  │
│   ┌─────────────┐      ┌─────────────┐                     │
│   │ INCR hits   │ ───► │ Увеличить   │ ───► новое = 43    │
│   └─────────────┘      │ на 1        │                     │
│                        └─────────────┘                     │
│   ┌─────────────┐      ┌─────────────┐                     │
│   │ GET hits    │ ───► │ Прочитать   │ ───► "42"          │
│   └─────────────┘      │ значение    │                     │
│                        └─────────────┘                     │
└─────────────────────────────────────────────────────────────┘
...
### 4.2. app.py (с измененной бизнес-логикой)
...
### 4.3. Dockerfile (с измененной инфрастуктурой)
...
### 4.4. docker-compose.yml (с измененной средой)
...
### 5.1. Изменение бизнес-логики (`app.py`)
...
### 5.2. Изменение инфраструктуры (`docker-compose.yml`)
...
### 5.3. Изменение среды сборки (Dockerfile)
