...
**Скриншот 2:** лог координатора при переключении (Connection refused).

**Скриншот 3:** Успешный запрос к серверу 5002 после отказа 5001 (среднее [10,20,30] -> 20.0).

**Скриншот 4:** Демонстрация работы всех аналитических функций (min/max, сумма, среднее).
